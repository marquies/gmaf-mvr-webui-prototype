                            ...
                            <div className='query-menu mt-1'>
                                <div className="dropdown m-1">
                                    ...
                                    <ul className="dropdown-menu">
                                        ...
                                        <li><button onClick={()=>this.props.filterChanged("Video")} className="dropdown-item" >Video 2D</button></li>
                                        <li><button onClick={()=>this.props.filterChanged("Doc")} className="dropdown-item" >Video 3D</button></li>     
